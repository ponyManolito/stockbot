...
public class StockScheduledTasks {
	...
	public void extractStats() throws ParseException, IOException {
		...
		for (String quote : quoteNames) {
			...
			stats.append(writeStats(quoteCode,1));
			stats.append(writeStats(quoteCode,2));
			stats.append(writeStats(quoteCode,3));
			stats.append(writeStats(quoteCode,4));
			stats.append(writeStats(quoteCode,5));
			File file = new File("/home/ivan/Documentos/stats/"+quoteCode+".txt");
